...
class Test(TestCase):
    ...
    def test_multiplied_corner_tiles(self):
        from src.day20_1 import multiplied_corner_tiles
        input_list = [
            'Tile 2311:\n',
            '..##.#..#.\n',
            '##..#.....\n',
            ...
            '..#.###...\n',
            '\n']
        correct_answer = 20899048083289
        self.assertTrue(multiplied_corner_tiles(input_list) == correct_answer)

    def test_get_monsterlessness(self):
        from src.day20_2 import get_monsterlessness
        input_list = [
            'Tile 2311:\n',
            '..##.#..#.\n',
            '##..#.....\n',
            ...
            '\n']
        correct_answer = 273
        self.assertTrue(get_monsterlessness(input_list) == correct_answer)
